...
class HomePageRxDart extends StatefulWidget {
  const HomePageRxDart({super.key});

  @override
  _HomePageRxDartState createState() => _HomePageRxDartState();
}

class _HomePageRxDartState extends State<HomePageRxDart> {
  ...
  _learnStream() async {
    ...
    // var subject = PublishSubject<String>(); this PublishSubject means will get items added after subscription
    var subject = BehaviorSubject<String>(); // this BehaviorSubject will supply the last event before subscription
